...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            digits: "Somente número são aceitos",
            creditcard: "Please enter a valid credit card number",
            equalTo: "Please enter the same value again",
            maxlength: $.validator.format("O campo precisa ter no máximo {0} caracteres"),
            minlength: $.validator.format("O campo precisa ter no mínimo {0} caracteres"),
            rangelength: $.validator.format("O campo precisa ter entre {0} e {1} caracteres"),
