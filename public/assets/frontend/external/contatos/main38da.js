...
(function () {
	...
	//var host = "http://cna.targetsoftware.com.br:8382/";
		...
		function make_buttonfooter_cnaola() {
			...
			buttonBottom.style.left = "70%";
            buttonBottom.style.top = "8%";
			...
			buttonBottomImage.setAttribute("src", host + "external/contatos/img/matricule_se.png");
			buttonBottomImage.setAttribute("alt", "Matricule-se Já");
			...
			buttonBottom.innerHTML +=
				'<a title="E-mail" class="btn-cnaola-footer" id="btn-cnaola-footer-email" style=" \
                    ...
                    left: 35px; \
                    top: 42px;"></a> \
                <a title="(11) 4020-0241" class="btn-cnaola-footer" id="btn-cnaola-footer-telefone" style=" \
                    height: 32px; \
                    width: 32px; \
                    position: absolute; \
                    left: 84px; \
                    top: 42px;"></a> \
                <a title="WhatsApp" href="https://api.whatsapp.com/send?phone=551130533800" target="_blank" class="btn-cnaola-footer" id="btn-whatsapp" style=" \
                    height: 32px; \
                    width: 32px; \
                    position: absolute; \
                    left: 134px; \
		...
		function make_barfooter_cnaola() {
			...
			request.open("GET", host + "external/contatos/html/footerbar-cnaola.html?v=" + ticks, true);
			request.send(null);
		...
		function makemodal_actions() {
			...
			btnChat.setAttribute("src", host + "external/contatos/img/Whatsapp_853339.png");
			btnChat.setAttribute("alt", "WhatsApp");
			btnChat.setAttribute("title", "WhatsApp");
            btnChat.setAttribute("width", "40%");//novo atributo tamanho
            btnChat.setAttribute("onclick","window.open('https://api.whatsapp.com/send?phone=551130533800')");    
			btnChat.id = "liveagent_button_online";
			btnChat.classList.add("img-rodape-cnaola");
			btnChat.style = "display: none;"

			//var btnChatOff = document.createElement("img");
			//btnChatOff.setAttribute("src", host + "external/contatos/img/Whatsapp_853339.png");
			...
			btnEmail.setAttribute("src", host + "external/contatos/img/email.png");
			...
			if (completePage) {
				...
				btnTeleVendas.setAttribute("src", host + "external/contatos/img/phone.png");
			...
			btnPhone.setAttribute("src", host + "external/contatos/img/phone.png");
		...
		function makefrm_email() {
			var ifrm = document.createElement("iframe");
			ifrm.setAttribute("src", host + "external/contatos/html/email-contatos.html?v=" + ticks);
		...
		function makefrm_telefone() {
            var ifrm = document.createElement("iframe");
            console.log("Teste cnaola telefone");
            console.log(host);
			ifrm.setAttribute("src", host + "external/contatos/html/telefone-contatos.html?v=" + ticks);
		...
		function makemodal_css() {
			...
			link.setAttribute("href", host + "external/contatos/style.css");
