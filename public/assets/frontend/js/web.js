...
(function ($) {
  if ($.fn.inputmask === undefined) {
    ...
    var isInputTypeSupported = function isInputTypeSupported(inputType) {
    ...
    var generateMaskSet = function generateMaskSet(opts, multi) {
      var ms = undefined;
      ...
      function analyseMask(mask) {
        ...
        while (match = tokenizer.exec(mask)) {
          ...
          switch (m.charAt(0)) {
            case opts.optionalmarker.end: // optional closing
      ...
      function preProcessMask(mask) {
        ...
        if (opts.numericInput) {
          //TODO FIX FOR DYNAMIC MASKS WITH QUANTIFIERS
    ...
    var maskScope = function maskScope(actionObj, maskset, opts) {
      var isRTL = false,
          undoValue,
          compositionValidPos,
          compositionCaretPos,
      ...
      ignorable = false,
          maxLength,
          firstClick = true; //maskset helperfunctions
        ...
        if (opts.insertMode && getMaskSet()["validPositions"][pos] != undefined && fromSetValid == undefined) {
          ...
          for (i = pos; i <= lvp; i++) {
            ...
            if (t != undefined) {
              ...
              if (!opts.keepStatic && vps[i] && (vps[i + 1] != undefined && getTests(i + 1, vps[i].locator.slice(), i).length > 1 || vps[i].alternation != undefined)) j = i + 1;else j = seekNext(i);
      ...
      function stripValidPositions(start, end) {
        ...
        for (i = startPos; i < end; i++) {
          //clear selection
          if (getMaskSet()["validPositions"][i] != undefined && (getMaskSet()["validPositions"][i].input != opts.radixPoint || i == getLastValidPosition())) delete getMaskSet()["validPositions"][i];
        }
        ...
        if (start <= lvp && getMaskSet()["validPositions"][lvp] != undefined && getMaskSet()["validPositions"][lvp].input == opts.radixPoint) delete getMaskSet()["validPositions"][lvp];
        resetMaskSet(true);
      }
      ...
      function getTestTemplate(pos, ndxIntlzr, tstPs) {
        ...
        for (var ndx = 0; ndx < testPositions.length; ndx++) {
          ...
          if (opts.greedy || testPos["match"] && (testPos["match"].optionality === false || testPos["match"].newBlockMarker === false) && testPos["match"].optionalQuantifier !== true && (lvTest.alternation == undefined || testPos["locator"][lvTest.alternation] != undefined && checkAlternationMatch(testPos.locator[lvTest.alternation].toString().split(","), lvTestAltArr))) {
            break;
          }
        }
            ...
            if (testPos == pos && match.matches == undefined) {
              ...
              if (match.isGroup && quantifierRecurse !== true) {
                ...
                if (altIndex == -1 || typeof altIndex == "string") {
                  ...
                  for (var amndx = 0; amndx < alternateToken.matches.length; amndx++) {
                    ...
                    for (var ndx1 = 0; ndx1 < maltMatches.length; ndx1++) {
                      ...
                      for (var ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
                        var altMatch2 = malternateMatches[ndx2]; //verify equality
                      ...
                      if (isFinite(ndx)) {
                        ...
                        for (var alndx = 0; alndx < altLocArr.length; alndx++) {
                          ...
                          if (mamatch) {
                            ...
                            } else lmnt.locator[loopNdxCnt] = parseInt(altLocArr[alndx]);
                          }
                        }
                  ...
                  matches = currentMatches.concat(malternateMatches); //console.log("alternates " + pos + " -> " + JSON.stringify(matches));
      ...
      function isValid(pos, c, strict, fromSetValid) {
        ...
        function alternate(pos, c, strict, fromSetValid) {
          var validPsClone = $.extend(true, {}, getMaskSet()["validPositions"]),
              lastAlt,
              alternation; //find last alternation
        ...
        var buffer = getBuffer(); //find previous valid
      ...
      function caret(input, begin, end) {
        ...
        if (typeof begin == 'number') {
          ...
          end = typeof end == 'number' ? end : begin; //store caret for multi scope
      ...
      function determineLastRequiredPosition(returnDefinition) {
        ...
        for (pos = bl - 1; pos > lvp; pos--) {
          ...
          if ((testPos.optionality || testPos.optionalQuantifier || lvTest && lvTest.alternation != undefined && positions[pos]["locator"][lvTest.alternation] != undefined && $.inArray(positions[pos]["locator"][lvTest.alternation].toString(), lvTestAltArr) != -1) && buffer[pos] == getPlaceholder(pos, testPos)) {
            bl--;
          } else break;
        }
            ...
            if (eventHandler.namespace == "inputmask") {
              if (eventHandler.type != "setvalue") {
                ...
                eventHandler.handler = function (e) {
                  ...
                  if (this.readOnly || this.disabled) e.preventDefault();else {
                    switch (e.type) {
                      case "input":
      ...
      function patchValueProperty(npt) {
        ...
        if (!npt._valueGet) {
          //var valueProperty;
          if (Object.getOwnPropertyDescriptor) var valueProperty = Object.getOwnPropertyDescriptor(npt, "value");

          if (valueProperty && valueProperty.configurable && false) {
            //experimental for chrome
      ...
      function handleRemove(input, k, pos) {
        ...
        if (k == $.inputmask.keyCode.BACKSPACE && pos.end - pos.begin <= 1) pos.begin = seekPrevious(pos.begin);else if (k == $.inputmask.keyCode.DELETE && pos.begin == pos.end) pos.end++;
      ...
      function keydownEvent(e) {
        ...
        } else if (opts.undoOnEscape && k == $.inputmask.keyCode.ESCAPE || k == 90 && e.ctrlKey) {
          //escape && undo
          ...
          if (k) {
            ...
            var pos = checkval ? {
              begin: ndx,
                ...
                forwardPosition,
                c = String.fromCharCode(k); //should we clear a possible selection??
            ...
            if (valResult !== false) {
              ...
              if (valResult.caret != undefined) forwardPosition = valResult.caret;else {
                var vps = getMaskSet()["validPositions"];
                if (!opts.keepStatic && (vps[p + 1] != undefined && getTests(p + 1, vps[p].locator.slice(), p).length > 1 || vps[p].alternation != undefined)) forwardPosition = p + 1;else forwardPosition = seekNext(p);
              }
      ...
      function pasteEvent(e) {
        var input = this,
            ...
            caretPos = caret(input); //paste event for IE8 and lower I guess ;-)
      ...
      function mask(el) {
        ...
        if ($el.is(":input") && isInputTypeSupported($el.attr("type"))) {
          ...
          $el.unbind(".inputmask"); //bind events
          ...
          $el.bind("mouseenter.inputmask", function () {
            ...
            if ($input.data('_inputmask')) {
              ...
              if (nptValue != '') {
                if (opts.clearMaskOnLostFocus) {
                  if (nptValue == getBufferTemplate().join('')) buffer = [];else {
                ...
                if (isComplete(buffer) === false) {
                  ...
                  if (opts.clearIncomplete) {
                    resetMaskSet();
                    if (opts.clearMaskOnLostFocus) buffer = [];else {
            ...
            checkVal(input, true, false);
            undoValue = getBuffer().join('');
            if ((opts.clearMaskOnLostFocus || opts.clearIncomplete) && input._valueGet() == getBufferTemplate().join('')) input._valueSet('');
          ...
          patchValueProperty(el); //apply mask
      ...
      if (actionObj != undefined) {
        switch (actionObj["action"]) {
          ...
          case "remove":
            ...
            $el = $(el);
            maskset = $el.data('_inputmask')['maskset'];
            opts = $el.data('_inputmask')['opts']; //writeout the unmaskedvalue

            el._valueSet(unmaskedvalue($el)); //unbind all events


            $el.unbind(".inputmask"); //clear data

            $el.removeData('_inputmask'); //restore the value property

            var valueProperty;
            if (Object.getOwnPropertyDescriptor) valueProperty = Object.getOwnPropertyDescriptor(el, "value");
    ...
    $.inputmask = {
      ...
      defaults: {
        ...
        //try to keep the mask static while typing. Decisions to alter the mask will be posponed if possible - undefined see auto selection for multi masks
        definitions: {
          '9': {
            validator: "[0-9]",
            cardinality: 1,
    ...
    $.fn.inputmask = function (fn, options, targetScope, targetData, msk) {
      ...
      function importAttributeOptions(npt, opts, importedOptionsContainer) {
        ...
        for (var option in opts) {
          ...
          if (optionData != undefined) {
            ...
            } else opts[option] = typeof optionData == "boolean" ? optionData : optionData.toString();

            if (importedOptionsContainer) importedOptionsContainer[option] = opts[option];
          }
        }
      ...
      if (typeof fn === "string") {
        switch (fn) {
          ...
          default:
            resolveAlias(opts.alias, options, opts); //check if the fn is an alias
...
/***/ 0:
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/assets/frontend/js/jquery-1.11.0.min8619.js ./resources/assets/frontend/js/jquery.inputmask.js ./resources/assets/frontend/js/passaporte.js ./resources/assets/frontend/js/EnumJS.js ***!
  \**************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\laragon\www\passaporteidiomas\resources\assets\frontend\js\jquery-1.11.0.min8619.js */"./resources/assets/frontend/js/jquery-1.11.0.min8619.js");
__webpack_require__(/*! C:\laragon\www\passaporteidiomas\resources\assets\frontend\js\jquery.inputmask.js */"./resources/assets/frontend/js/jquery.inputmask.js");
__webpack_require__(/*! C:\laragon\www\passaporteidiomas\resources\assets\frontend\js\passaporte.js */"./resources/assets/frontend/js/passaporte.js");
